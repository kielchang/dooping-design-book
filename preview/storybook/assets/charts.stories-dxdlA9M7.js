import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as he}from"./index-UiW3gZKV.js";import{L as je,B as K}from"./legend-BFZkQJaL.js";import{c as N,f as k,a as S}from"./utils-DBXtLcuW.js";import{C as U,e as we,d as V,P as h,b as z,a as P,c as Te,S as Se}from"./stacked-bar-DXyWzelo.js";import{T as fe}from"./trend-chart-CNbmxg4Q.js";import{B as F}from"./badge-Cl3jk1vO.js";import{a as p,S as T}from"./sample-data-I9KaR9SF.js";import{b as I,c as Ne}from"./generate-Bsle_8tt.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C9IEqVQG.js";function H({data:t,title:l="柏拉圖",maxItems:n=12,valueFmt:r=V,onSelect:i,selectedIndex:m,height:s=180,className:d}){if(t.length===0)return e.jsx(U,{});const u=we([...t].sort((a,c)=>c.value-a.value),n),b=Math.max(1,u.reduce((a,c)=>a+c.value,0)),x=Math.max(1,...u.map(a=>a.value)),o=56,f={top:10,bottom:20},y=s-f.top-f.bottom,j=u.length*o;let q=0;const g=u.map(a=>(q+=a.value)/b),v=a=>a*o+10+(o-20)/2,w=a=>f.top+(1-a)*y,E=g.findIndex(a=>a>=.8);return e.jsxs("div",{className:N("overflow-x-auto",d),children:[e.jsxs("svg",{role:"img","aria-label":`${l}，共 ${u.length} 項，前 ${E+1} 項累積佔 ${Math.round(g[Math.max(E,0)]*100)}%`,viewBox:`0 0 ${j} ${s}`,width:j,height:s,className:"block",children:[e.jsx("line",{x1:0,y1:s-f.bottom,x2:j,y2:s-f.bottom,stroke:"var(--chart-axis)"}),u.map((a,c)=>{const $=a.value/x*y,D=c*o+10,ve=m!=null&&m!==c;return e.jsxs("g",{onClick:i?()=>i(c,a):void 0,className:N(i&&"cursor-pointer"),children:[e.jsx("title",{children:`${a.label}：${r(a.value)}（累積 ${Math.round(g[c]*100)}%）`}),e.jsx("rect",{x:D,y:s-f.bottom-$,width:o-20,height:$,fill:h[0],opacity:ve?.35:1}),e.jsx("text",{x:D+(o-20)/2,y:s-6,textAnchor:"middle",fontSize:10,fill:"var(--chart-text)",children:a.label})]},a.id??a.label)}),e.jsx("polyline",{points:g.map((a,c)=>`${v(c)},${w(a)}`).join(" "),fill:"none",stroke:"var(--chart-text)",strokeWidth:1.5}),g.map((a,c)=>e.jsx("circle",{cx:v(c),cy:w(a),r:2.5,fill:"var(--chart-text)"},c))]}),e.jsx(z,{caption:`${l}（資料表，含累積佔比）`,head:["項目","數值","累積"],rows:u.map((a,c)=>[a.label,r(a.value),`${Math.round(g[c]*100)}%`]),onSelect:i?a=>i(a,u[a]):void 0,selectedIndex:m})]})}H.__docgenInfo={description:`柏拉圖：長條由大到小 ＋ 累積百分比折線。回答「前幾項就佔掉多少」。
