import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as s}from"./index-UiW3gZKV.js";import{B as i}from"./button-PlLiai67.js";import{I as L}from"./input-vSeq6R7n.js";import{L as d}from"./label-DmCCWqIB.js";import{N as H}from"./number-input-DJbZuNmz.js";import{S as q}from"./seg-group-D0IDbvdD.js";import{C as V}from"./chips-DzzKURvw.js";import{S as M}from"./stepper-Bl9BkPqb.js";import{C as Q}from"./callout-9PJf-2LB.js";import{C as f,a as b,d as S,b as y,c as T}from"./card-CFhhONKA.js";import{D as A,a as G,b as z,c as J,d as K,e as W,f as X,g as Y}from"./dialog-BGzFPbaD.js";import{S as F,a as P,b as _,c as E,d as R}from"./select-BimLQx0-.js";import{a as Z}from"./utils-pm6Xa0Qd.js";import{T as $,C as ee,a as te}from"./sample-data-I9KaR9SF.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-VXoYh6zd.js";import"./index-rhYpeUg2.js";import"./index-BJ3p15Kd.js";import"./index-3b7XovMV.js";import"./index-BA8NevWa.js";import"./check-CZys2X9e.js";import"./createLucideIcon-BcR0bl2m.js";import"./index-C-xWP-pl.js";import"./Combination-Gi-zDQIY.js";import"./x-DHctwwaT.js";import"./index-Btum-Xq9.js";import"./index-BmqVfOSQ.js";const Oe={title:"頁面/表單頁"},h=[...new Set(te.map(g=>g.unit))],p={render:function(){const[a,r]=s.useState(""),[o,c]=s.useState(10),[C,m]=s.useState("gold"),[j,u]=s.useState(["online"]),[v,l]=s.useState(!1),t=v&&a.trim()==="";return e.jsxs("div",{className:"mx-auto max-w-2xl space-y-4",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-semibold",children:"建立項目"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"填完基本資訊即可送出，其餘設定之後隨時可補。"})]}),t&&e.jsx(Q,{variant:"warning",title:"有 1 個欄位待補",live:!0,children:"「項目名稱」未填寫前無法送出。"}),e.jsxs(f,{children:[e.jsxs(b,{children:[e.jsx(S,{className:"text-base",children:"基本資訊"}),e.jsx(y,{children:"這個項目是什麼、屬於誰。"})]}),e.jsxs(T,{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx(d,{htmlFor:"fp-name",children:"項目名稱（必填）"}),e.jsx(L,{id:"fp-name",value:a,placeholder:"例：甲案 第一階段","aria-invalid":t||void 0,"aria-describedby":t?"fp-name-err":void 0,onChange:n=>r(n.target.value)}),t&&e.jsx("p",{id:"fp-name-err",className:"text-tiny text-danger",children:"請輸入項目名稱。"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(d,{htmlFor:"fp-unit",children:"所屬單位"}),e.jsxs(F,{defaultValue:h[0],children:[e.jsx(P,{id:"fp-unit",children:e.jsx(_,{})}),e.jsx(E,{children:h.map(n=>e.jsx(R,{value:n,children:n},n))})]})]}),e.jsx(q,{label:"等級",options:$,value:C,onPick:m})]})]}),e.jsxs(f,{children:[e.jsxs(b,{children:[e.jsx(S,{className:"text-base",children:"數量與管道"}),e.jsx(y,{children:"之後在明細頁隨時可以調整。"})]}),e.jsxs(T,{className:"space-y-4",children:[e.jsxs("div",{className:"max-w-40 space-y-1",children:[e.jsx(d,{children:"數量"}),e.jsx(H,{value:o,onChange:c,min:1,step:10,"aria-label":"數量"})]}),e.jsx(V,{label:"聯絡管道",options:ee,selected:j,onToggle:n=>u(N=>N.includes(n)?N.filter(U=>U!==n):[...N,n])})]})]}),e.jsxs("div",{className:"flex items-center justify-between border-t pt-4",children:[e.jsxs(A,{children:[e.jsx(G,{asChild:!0,children:e.jsx(i,{variant:"ghost",children:"取消"})}),e.jsxs(z,{children:[e.jsxs(J,{children:[e.jsx(K,{children:"要放棄這份表單？"}),e.jsx(W,{children:"已填的內容不會保留。"})]}),e.jsxs(X,{children:[e.jsx(Y,{asChild:!0,children:e.jsx(i,{variant:"outline",children:"繼續填寫"})}),e.jsx(i,{variant:"destructive",children:"放棄"})]})]})]}),e.jsx(i,{onClick:()=>l(!0),children:"送出"})]})]})}},x={render:function(){const a=[{key:"unit",label:"選擇單位"},{key:"items",label:"加入項目",hint:"名稱與數量"},{key:"review",label:"確認送出"}],[r,o]=s.useState(0),[c,C]=s.useState(h[0]),[m,j]=s.useState("甲案 第一階段"),[u,v]=s.useState(120),l=a[r].key;return e.jsxs("div",{className:"mx-auto max-w-2xl space-y-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-semibold",children:"建立批次"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"三步完成；可以隨時回上一步，已填的內容不會不見。"})]}),e.jsx(M,{current:l,onStep:t=>o(a.findIndex(n=>n.key===t)),completed:Object.fromEntries(a.map((t,n)=>[t.key,n<r])),steps:a}),l==="unit"&&e.jsxs("div",{className:"max-w-sm space-y-1",children:[e.jsx(d,{htmlFor:"ms-unit",children:"所屬單位"}),e.jsxs(F,{value:c,onValueChange:C,children:[e.jsx(P,{id:"ms-unit",children:e.jsx(_,{})}),e.jsx(E,{children:h.map(t=>e.jsx(R,{value:t,children:t},t))})]})]}),l==="items"&&e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx(d,{htmlFor:"ms-name",children:"項目名稱"}),e.jsx(L,{id:"ms-name",value:m,onChange:t=>j(t.target.value)})]}),e.jsxs("div",{className:"max-w-40 space-y-1",children:[e.jsx(d,{children:"數量"}),e.jsx(H,{value:u,onChange:v,min:1,step:10,"aria-label":"數量"})]})]}),l==="review"&&e.jsxs(f,{children:[e.jsxs(b,{children:[e.jsx(S,{className:"text-base",children:"最後確認"}),e.jsx(y,{children:"送出後會建立 1 筆批次，內容仍可在明細頁調整。"})]}),e.jsxs(T,{className:"space-y-1 text-sm",children:[e.jsxs("p",{children:[e.jsx("span",{className:"text-muted-foreground",children:"所屬單位　"}),c]}),e.jsxs("p",{children:[e.jsx("span",{className:"text-muted-foreground",children:"項目名稱　"}),m]}),e.jsxs("p",{children:[e.jsx("span",{className:"text-muted-foreground",children:"數量　　　"}),Z(u)]})]})]}),e.jsxs("div",{className:"flex items-center justify-between border-t pt-4",children:[e.jsx(i,{variant:"outline",disabled:r===0,onClick:()=>o(t=>t-1),children:"上一步"}),r<a.length-1?e.jsx(i,{onClick:()=>o(t=>t+1),children:"下一步"}):e.jsx(i,{children:"送出"})]})]})}};var D,I,k;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(B=(O=x.parameters)==null?void 0:O.docs)==null?void 0:B.source}}};const Be=["典型組成","多步驟"];export{Be as __namedExportsOrder,Oe as default,p as 典型組成,x as 多步驟};
