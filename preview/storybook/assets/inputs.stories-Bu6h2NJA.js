import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./index-BFQ_Q9OP.js";import{I as d}from"./index-YW0vehpY.js";import{L as n}from"./label-D5EPj26R.js";import{N as O}from"./number-input-Dj-VORi-.js";import{C as E}from"./checkbox-_WC6A096.js";import{S as P,a as w,b as _,c as G,d as H}from"./select-CbCVKR29.js";import{S as v}from"./seg-group-C31EXuC6.js";import{C as q}from"./chips-hPkBPIX5.js";import{T as p,C as Q}from"./sample-data-DlVwqcXX.js";import"./utils-pm6Xa0Qd.js";import"./Combination-DsSBML8Q.js";import"./index-DdXKfkXy.js";import"./index-BvEpo9bQ.js";import"./index-CI1UOwFw.js";import"./check-SsieMrcg.js";import"./createLucideIcon-DDRU598s.js";const ne={title:"元件/表單/輸入控制項"},c={render:function(){const[a,t]=r.useState(120);return e.jsxs("div",{className:"max-w-sm space-y-4",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"s-name",children:"單位名稱"}),e.jsx(d,{id:"s-name",defaultValue:"遠東貿易股份有限公司"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"s-code",children:"單位代號"}),e.jsx(d,{id:"s-code",placeholder:"例：C-1042"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"s-locked",children:"建立日期"}),e.jsx(d,{id:"s-locked",defaultValue:"2019-04-01",disabled:!0})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{children:"訂購數量"}),e.jsx(O,{value:a,onChange:t,min:0,step:10,"aria-label":"訂購數量"}),e.jsx("p",{className:"text-tiny text-muted-foreground",children:"數值輸入固定右對齊＋等寬數字，底色＝「可編輯」語意。"})]})]})}},o={render:function(){const[a,t]=r.useState(!0);return e.jsxs("div",{className:"max-w-xl space-y-5",children:[e.jsxs("p",{className:"text-sm text-muted-foreground",children:["一格欄位可以",e.jsx("strong",{children:"同時"}),"是「被聚焦」「改過沒送」「不合格」。三件事走三個不同的通道， 疊起來互不干涉——",e.jsx("strong",{children:"聚焦環永遠是同一個顏色"}),"，邊框與底色管狀態。"]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"f-ro",children:"唯讀／計算值"}),e.jsx("div",{className:"field-readonly rounded-md border border-transparent px-3 py-2 text-sm",children:"1,380,000"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"f-ok",children:"可編輯（優先序 0）"}),e.jsx(d,{id:"f-ok",defaultValue:"1,500,000"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"f-edit",children:"已改動未送出（優先序 1）"}),e.jsx("div",{className:"rounded-md border border-edit bg-edit-bg px-3 py-2 text-sm text-edit-foreground",children:"1,650,000"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{htmlFor:"f-bad",children:"不合格（優先序 2，最高）"}),e.jsx(d,{id:"f-bad",defaultValue:"0","aria-invalid":a,"aria-describedby":"f-bad-err",onChange:s=>t(s.target.value==="0")}),a&&e.jsx("p",{id:"f-bad-err",className:"text-tiny text-danger",children:"數值必須大於 0。改成別的值就會恢復。"})]})]}),e.jsxs("p",{className:"text-xs text-muted-foreground",children:["用 Tab 鍵走過上面四格，注意",e.jsx("strong",{children:"聚焦環不隨狀態變色"}),"。 若環會跟著變紅，Tab 過三個必填空欄時每一格都會閃紅——那會訓練使用者忽略紅色。 環與邊框之間有一圈背景色（",e.jsx("code",{children:"ring-offset"}),"）：少了它，環會直接畫在紅框上， 實測深色模式下兩者對比只有 ",e.jsx("strong",{children:"1.04:1"}),"，聚焦環等於隱形。"]}),e.jsxs("p",{className:"text-xs text-muted-foreground",children:["「",e.jsx("strong",{children:"必填未填"}),"」是不合格的一種，但它的問題是",e.jsx("strong",{children:"時機"}),"不是顏色—— 不該在使用者還沒碰過欄位時就標紅。慣例是 blur 或送出之後才標。"]})]})}},i={render:function(){const[a,t]=r.useState(!0);return e.jsxs("div",{className:"max-w-sm space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(E,{id:"s-active",checked:a,onCheckedChange:s=>t(s===!0)}),e.jsx(n,{htmlFor:"s-active",children:"啟用此單位"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx(n,{children:"等級"}),e.jsxs(P,{defaultValue:"gold",children:[e.jsx(w,{children:e.jsx(_,{})}),e.jsx(G,{children:p.map(s=>e.jsx(H,{value:s.value,children:s.label},s.value))})]})]})]})}},m={render:function(){const[a,t]=r.useState("gold"),[s]=r.useState("silver");return e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"選項少、標籤短、要一眼看完 → 分段選擇"}),e.jsx(v,{label:"等級",options:p,value:a,onPick:t})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"已改動未送出（琥珀）"}),e.jsx(v,{label:"等級（已改動）",options:p,value:a,onPick:t,changed:!0})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"鎖定：可聚焦、有鎖頭、hover 有原因"}),e.jsx(v,{label:"等級（鎖定）",options:p,value:s,onPick:()=>{},disabled:!0,lockHint:"此筆已結案，需先解除鎖定"})]}),e.jsx("p",{className:"text-tiny text-muted-foreground",children:"鍵盤：方向鍵移動、Space/Enter 選定、Esc 取消。整組只佔一個 Tab 停留點。"})]})}},u={render:function(){const[a,t]=r.useState(["web","phone"]);return e.jsxs("div",{className:"max-w-md space-y-2",children:[e.jsx(q,{label:"下單管道",options:Q,selected:a,onToggle:s=>t(x=>x.includes(s)?x.filter(V=>V!==s):[...x,s])}),e.jsx("p",{className:"text-tiny text-muted-foreground",children:"已選與未選同時看得見——多選下拉「選完就看不見選了什麼」是後台最常見的抱怨。"})]})}};var h,g,f;c.parameters={...c.parameters,docs:{...(h=c.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(f=(g=c.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var b,N,j;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: function Render() {
...
}`,...(R=(F=u.parameters)==null?void 0:F.docs)==null?void 0:R.source}}};const re=["文字與數值","欄位狀態","勾選與下拉","分段選擇","多選標籤片"];export{re as __namedExportsOrder,ne as default,m as 分段選擇,i as 勾選與下拉,u as 多選標籤片,c as 文字與數值,o as 欄位狀態};
