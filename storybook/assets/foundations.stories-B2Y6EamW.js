        ...
        color: fg(mode)
            ...
            <div className="flex gap-1.5">
              {pal(mode).map((c, i) => <div key={i} className="flex-1 space-y-1">
                  <div className="h-10 rounded-sm" style={{
              background: c
            }} aria-hidden />
  ...
  render: () => <div className="space-y-5">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="space-y-2 rounded-md border p-3">
          ...
          <div className="pt-1">
            <input aria-label="聚焦環示意" className="w-full rounded-md border border-input bg-background px-3 py-1.5 text-sm ring-2 ring-ring ring-offset-2 ring-offset-background" defaultValue="聚焦環是中性色（ADR-0007）" readOnly />
          </div>
...
}`,...(b=(y=c.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var k,w,E;l.parameters={...l.parameters,docs:{...(k=l.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(E=(w=l.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};var S,R,$;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...($=(R=i.parameters)==null?void 0:R.docs)==null?void 0:$.source}}};const _=["語意色","圖表色票","色相主題","字級與間距","欄位語意"];export{_ as __namedExportsOrder,L as default,o as 圖表色票,l as 字級與間距,i as 欄位語意,c as 色相主題,t as 語意色};
