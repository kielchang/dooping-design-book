...
const translatedDocs = [
  ...
  "3-components/13-data-table.mdx",
  ...
  "3-components/22-lib.mdx",
  "3-components/24-gantt.mdx",
  "3-components/25-graph-canvas.mdx",
  "3-components/26-form-controls.mdx",
  "3-components/23-charts.mdx",
  "6-accessibility/01-principles.mdx",
  "6-accessibility/02-checklist.mdx",
  "6-accessibility/03-implementation-map.mdx",
  "4-patterns/01-inline-field-editing.mdx",
  "4-patterns/02-scenario-request-form.mdx",
  "4-patterns/03-hard-lock.mdx",
  "4-patterns/04-audit-and-restore.mdx",
  "4-patterns/05-effective-dated-settings.mdx",
  "4-patterns/06-guided-tour.mdx",
